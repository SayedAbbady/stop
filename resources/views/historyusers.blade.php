                    ...
                    @foreach ($activity as $item)
                        ...
                        <tr >
                          ...
                          <td style="font-size:15px">
                            <p class="badge badge-dark d-block text-left ">{{$user->name}}</p>
                          </td>
                          
                          <td class="">
                            <p>{{$user->name}} {{$item->description}} => {{$item->log_name}}</p>
                          </td>
                          ...
                          <td class="">
                            ...
                            @endif
                            {{-- <button type="button" class="btn btn-primary getDetaislData" data-type="" data-id="{{$item->id}}" data-token="{{csrf_token()}}" data-toggle="modal" data-target="#exampleModal">
                              Show details
                            </button> --}}
                          </td>
                        </tr>
